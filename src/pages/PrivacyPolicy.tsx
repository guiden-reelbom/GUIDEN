      ...
      <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-12 text-gray-400 leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-white mb-6">제6조 (개인정보처리의 위탁)</h2>
              <p>1. 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
              <div className="space-y-4 pl-4">
                <p>가. 이메일 발송 대행 (수탁자: EmailJS / 내용: 문의 접수 알림 발송 / 기간: 서비스 제공 기간 동안)</p>
                <p>나. 클라우드 서비스 (수탁자: Google Cloud / 내용: 웹사이트 운영 및 데이터 관리 / 기간: 서비스 제공 기간 동안)</p>
              </div>
              <p>2. 회사는 위탁계약 체결 시 제26조에 따라 목적 외 처리금지, 보안조치, 재위탁 제한, 관리감독, 손해배상 등 사항을 문서에 명시하고 안전하게 처리하는지 감독합니다.</p>
              <p>3. 위탁업무 변경 시 지체 없이 이 방침을 통해 공개하겠습니다.</p>
            </section>
